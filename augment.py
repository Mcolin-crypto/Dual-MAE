...
func_dict = {
    'CenterResizeCrop':CenterResizeCrop(scale_begin = 23, windowsize = args.windowsize),
    'RandomResizeCrop':RandomResizeCrop(scale = [0.7, 1], probability = 0.5),
    'CenterCrop':CenterCrop(scale_begin = 23, windowsize = args.windowsize, probability = 0.5),
}
...
class RandomAugment(object):
    ...
    def get_random_ops(self):
        ...
        return [(op, 1.) for op in sampled_ops]
